...
data:
  ...
  code: "package algorithm\n\nimport \"errors\"\n\nvar ErrStack117Empty = errors.New(\"\
    Stack117: stack is empty\")\n\n// A stack structure.\ntype Stack117 struct {\n\
    ...
    \ (s *Stack117) PushRange(v []interface{}) {\n\tfor i := 0; i < len(v); i++ {\n\
  ...
  - verify/aoj-ALDS1_3_A-stack.test.go
  - verify/aoj-ALDS1_3_A-stack117.test.go
documentation_of: algorithm/stack117.go
layout: document
redirect_from:
- /library/algorithm/stack117.go
- /library/algorithm/stack117.go.html
